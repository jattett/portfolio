      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: "16px",
            background:
              "radial-gradient(circle, #39ff14 0%, rgba(57, 255, 20, 0.6) 70%, transparent 100%)",
            borderRadius: "50%",
        ...
        {[...Array(3)].map((_, index) => (
          <div
            ...
            style={{
              ...
              height: "8px",
              background:
                "radial-gradient(circle, rgba(57, 255, 20, 0.8) 0%, rgba(57, 255, 20, 0.4) 70%, transparent 100%)",
              borderRadius: "50%",
        ...
        {[...Array(5)].map((_, index) => (
          <div
            ...
            style={{
              ...
              height: "4px",
              background:
                "radial-gradient(circle, rgba(57, 255, 20, 0.6) 0%, transparent 100%)",
              borderRadius: "50%",
